#include "MidiAccompanimentGenerator.h"
#include "IPlug_include_in_plug_src.h"
#include "IControls.h"

MidiAccompanimentGenerator::MidiAccompanimentGenerator(const InstanceInfo& info)
...
#if IPLUG_DSP
void MidiAccompanimentGenerator::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void MidiAccompanimentGenerator::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
