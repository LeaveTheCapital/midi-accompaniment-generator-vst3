...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MidiAccompanimentGenerator Demo Installer\n"
      else:
        line="OutputBaseFilename=MidiAccompanimentGenerator Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MidiAccompanimentGenerator Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MidiAccompanimentGenerator installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MidiAccompanimentGenerator Demo installer\n"
     else:
       line="SetupWindowTitle=MidiAccompanimentGenerator installer\n"
