...
def  main():
  ...
  installer = "\installer\MidiAccompanimentGenerator Installer.exe"
   
  if demo:
    installer = "\installer\MidiAccompanimentGenerator Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\MidiAccompanimentGenerator manual.pdf" 
  ]
  ...
  ZIPNAME = "MidiAccompanimentGenerator-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "MidiAccompanimentGenerator-v" + FULLVERSIONSTR + "-win-demo.zip"
