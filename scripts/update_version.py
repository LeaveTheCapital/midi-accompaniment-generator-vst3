...
def main():
  ...
  plistpath = scriptpath + "/resources/MidiAccompanimentGenerator-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiAccompanimentGenerator-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiAccompanimentGenerator-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiAccompanimentGenerator-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiAccompanimentGenerator-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/MidiAccompanimentGenerator.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MidiAccompanimentGenerator.iss",inplace=1):
